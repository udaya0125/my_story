  ...
  return (
    <footer className="relative w-full bg-black/90">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-12 mb-12 lg:mb-16">
          {/* Brand Section - Left */}
          <div className="lg:col-span-4 space-y-4 md:space-y-6">
            ...
            <p className="text-white/90 text-sm md:text-base font-light leading-relaxed max-w-md">
              An epic tale of ancient spirits, forgotten magic, and a prophecy
              that will change everything. The journey begins where whispers
              echo through time.
            </p>
