            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 lg:py-24">
                <div className="text-center mb-20 md:mb-24">
                    ...
                    <p className="max-w-3xl mx-auto mt-10 text-[#5C5550] text-base sm:text-lg font-light leading-relaxed">
                        Let each line be a lantern. These verses hold quiet storms, gentle mornings, and the
                        music of memory.
                    </p>
                </div>
                                ...
                                >
                                    ...
                                    <div className="p-7 bg-white">
                                        ...
                                        <div className="mt-6 flex items-center justify-between">
                                            ...
                                            <Link to={`/poem/${poem.slug}`} className="text-[#FE7743] text-xs font-mono tracking-wider">
                                                READ POEM
                                            </Link>
                                        </div>
                                    </div>
